...
namespace Para_1
{
    class MeshObject : Game3DObject, IDisposable
    {
        ...
        private bool _fillModeSolid;
        public bool FillModeSolid { get => _fillModeSolid; }
        ...
        public MeshObject(DirectX3DGraphics directX3DGraphics, 
            ...
            bool visible, ObjectType objectType, bool fillModeSolid = true)
